...
namespace t1
{
    class Program
    {
        ...
        {
            products.Add(new Meat("Chicken shin", 1.64f, 573.95f, new DateTime(2021, 6, 20), 20, Category.HighestGrade, Type.Chicken));
            products.Add(new Diary_products("Cheese", 1.6f, 1075.10f, new DateTime(2021, 8, 30), 30));
            products.Add(new Meat("Thigh", 0.173f, 262.0f, 25, Category.SecondGrade, Type.Pork));
            ...
            for(int i = 0; i < storageSize; i++)
            {
                ...
                switch(productType)
                {
                    case 1:
                        ...
                        newProducts[i] = new Meat(name, weight, price, 0, newCategory, newType);
                        break;
                    case 2:
                        ...
                        break;
                    default:
                        newProducts[i] = new Product(name, weight, price, 0);
                        break;
                }
                Console.WriteLine();
            }
